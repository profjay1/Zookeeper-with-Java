...
public class Main {
    public static void main(String[] args) {
        ...
        while (!(input = scanner.next()).equals("exit")) {
            System.out.println(input.equals("0") ? animals[0] :
                                input.equals("1") ? animals[1] :
                                input.equals("2") ? animals[2] :
                                input.equals("3") ? animals[3] :
                                input.equals("4") ? animals[4] :
                                input.equals("5") ? animals[5] : "");
            System.out.println("Please enter the number of the habitat you would like to view: ");
        }
